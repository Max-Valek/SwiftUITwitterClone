...
extension Tweet {
    ...
    static var forYouTweets: [Tweet] = [
        ...
        Tweet(author: User.doge, date: "2m", text: "This is another For You Tweet", images: nil, likes: 100, retweets: 12, bookmarks: 25, views: 200),
        Tweet(author: User.doge, date: "5m", text: "It seems like you would like this tweet, so here is it on your For You page", images: nil, likes: 1005, retweets: 102, bookmarks: 75, views: 2000),
        ...
        Tweet(author: User.doge, date: "25m", text: "You follow this page so we will sprinkle it in to your For You page.", images: nil, likes: 15, retweets: 1, bookmarks: 0, views: 85),
